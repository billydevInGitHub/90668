...
@AllArgsConstructor <--33808Exp146
@Builder  <--33808Exp132 
@Data   <--33808Exp053
...
Spring Boot Actuator
       http://localhost:8080/actuator  overall Url  <--from Exp096,list all url for actuator
...
logging.file.path=C:\\Temp\\200501    <--exp067
...
JavaScript Global Objects Array reduce function (https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Array/Reduce)

JavaScript Global Objects Array slice function (https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Array/splice)

JavaScript Global Objects JSON (https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/JSON)
